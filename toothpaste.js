(function(root, factory) {
  ...
  **/
  ...
  var inherits = function(ctor, parent) {
    ctor.super_ = parent;
  ...
  Dispatcher.prototype = extend(Dispatcher.prototype, {
    _registerActionHandler: function (action, handler) {
    ...
    _activatePromise: function (idx, handler, args) {
  ...
  Action.extend = function (ChildProto) {
    ...
    inherits(ChildFn, Action);
    ChildFn.prototype = extend(ChildFn.prototype, ChildProto);
    return ChildFn;
  };

  var FluxConstants = function (constants) {
    var values = {};
    if (constants) {
  ...
  Object.keys(React.DOM).forEach(tagName)(function() {
